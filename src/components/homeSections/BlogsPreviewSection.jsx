...
const previewBlogs = [
  {
    ...
    platformLogo: '/assets/img/av.png',
  ...
  },
  {
    ...
    platformLogo: '/assets/img/gfg.png',
  ...
  },
  {
    ...
    platform: 'Analytics Vidhya',
    platformLogo: '/assets/img/av.png',
    imageUrl: '/assets/img/script.jpg',
  ...
  { // New 6th blog post for the preview
    ...
    platform: 'GeeksForGeeks',
    platformLogo: '/assets/img/gfg.png',
    imageUrl: '/assets/img/pyjanitor.png', // Ensure this image exists in public/assets/img
